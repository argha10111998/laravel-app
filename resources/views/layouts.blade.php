                    ...
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li><a href="javascript:void(0)">Men</a>
                                <ul class="dropdown">
                                    <li><a href="/category/men_jeans">Men Jeans</a></li>
                                    <li><a href="/category/men_shirts">Men Shirts</a></li>
                                   
                                </ul>
                            </li>
                            <li><a href="javascript:void(0)">Women</a>
                                <ul class="dropdown">
                                    <li><a href="/category/women_jeans">Women Jeans</a></li>
                                    <li><a href="/category/women_shirts">Women Shirts</a></li>
                                </ul>
                            </li>
